...
function handleLookup(query, doneCallback) {
	...
	{
		handleLookupAjaxSuccess(movieHashMap[query], query, doneCallback) 
...
function handleSelectSuggestion(suggestion) {
	...
	var url = suggestion["data"]["category"] + "-hero" + "?id=" + suggestion["data"]["id"]
		if (suggestion["data"]["category"] == "Movies")
			window.location = "./movieSinglePage?movieTitle=" + suggestion["value"];
		else
			window.location = "./starPage?actor=" + suggestion["value"];
	console.log(url)
}
...
function handleNormalSearch(query) {
	...
	window.location = "./searchPage?page=1&method=normalSearch&numPerPage=15&sort=titleA&title=" + query;
}
